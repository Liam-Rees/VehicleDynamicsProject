 ...
 *    C source code generated on : 12-Jun-2024 17:24:15
 *
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtBusInfo[15] = 200*__dtSizeInfo[2];
        ...
        __dtBusInfo[37] = 200*__dtSizeInfo[2];
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    {
        uint32_T chk[] = {1765452281, 2029715508, 273167338, 1981799272};
        int_T status;
    ...
    {
        uint32_T chk[] = {1776948747, 1540954060, 1845144059, 2118223483};
        int_T status;
    ...
    {
        uint32_T chk[] = {2093646310, 1300748602, 786793705, 2599541873};
        int_T status;
