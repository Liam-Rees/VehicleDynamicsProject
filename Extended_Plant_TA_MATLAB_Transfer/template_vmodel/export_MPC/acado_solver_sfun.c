 ...
 *    C source code generated on : 17-Jun-2024 12:14:33
 *
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtBusInfo[13] = 12*__dtSizeInfo[2];
        ...
        __dtBusInfo[15] = 35*__dtSizeInfo[2];
        ...
        __dtBusInfo[31] = 18*__dtSizeInfo[2];
        ...
        __dtBusInfo[35] = 12*__dtSizeInfo[2];
        ...
        __dtBusInfo[37] = 35*__dtSizeInfo[2];
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    {
        uint32_T chk[] = {3219732317, 944564808, 1829823786, 3780183119};
        int_T status;
    ...
    {
        uint32_T chk[] = {3741347323, 1173281694, 2844970428, 102333738};
        int_T status;
    ...
    {
        uint32_T chk[] = {4037668389, 2068140502, 3555936576, 1581855829};
        int_T status;
