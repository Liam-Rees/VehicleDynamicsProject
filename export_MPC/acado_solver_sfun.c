 ...
 *    C source code generated on : 03-Jun-2024 17:04:40
 *
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtBusInfo[29] = 41*__dtSizeInfo[2];
        ...
        __dtBusInfo[37] = 4*__dtSizeInfo[2];
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    {
        uint32_T chk[] = {2545663521, 3038645046, 3953313261, 3712902983};
        int_T status;
    ...
    {
        uint32_T chk[] = {1583054717, 795841611, 115264156, 4079905597};
        int_T status;
    ...
    {
        uint32_T chk[] = {2755967625, 3699425304, 1514732059, 1277565530};
        int_T status;
