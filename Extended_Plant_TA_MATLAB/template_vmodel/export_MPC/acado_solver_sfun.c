 ...
 *    C source code generated on : 11-Jun-2024 17:48:41
 *
...
static void mdlStart(SimStruct *S)
{
    if (IS_SIMULATION_TARGET(S)) {
        ...
        __dtBusInfo[13] = 280*__dtSizeInfo[2];
        ...
        __dtBusInfo[33] = 280*__dtSizeInfo[2];
...
static void CheckDataTypes(SimStruct *S)
{
    ...
    {
        uint32_T chk[] = {3910948460, 2372458529, 4034501543, 3847185668};
        int_T status;
    ...
    {
        uint32_T chk[] = {478083681, 3076607191, 4093745522, 3021572536};
        int_T status;
    ...
    {
        uint32_T chk[] = {3589229828, 2133249524, 4091463132, 3555272465};
        int_T status;
