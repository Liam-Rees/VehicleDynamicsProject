...
out[2] = ((((((real_t)(0.0000000000000000e+00)-(((((real_t)(0.0000000000000000e+00)-u[1])+u[0])-u[3])+u[2]))*(real_t)(7.8800000000000003e-01))/(real_t)(7.9957074999999998e+02))+(((real_t)(3.8360220155627253e+01)/xd[0])*xd[1]))-(((real_t)(2.2981725564623270e+02)*xd[2])/xd[0]));
}
