...
out[2] = (((((real_t)(3.8360220155627253e+01)/xd[0])*xd[1])-(((real_t)(2.2981725564623270e+02)*xd[2])/xd[0]))+((real_t)(3.7957866767887642e-04)*u[0]));
}
...
out[4] = ((((real_t)(0.0000000000000000e+00)-((real_t)(-2.2463768115942028e+02)*a[1]))*xd[1])+((((real_t)(0.0000000000000000e+00)-((real_t)(7.3231884057971016e+01)*a[3]))-(real_t)(1.0000000000000000e+00))*xd[2]));
out[5] = ((real_t)(-2.2463768115942028e+02)/xd[0]);
out[6] = (((real_t)(7.3231884057971016e+01)/xd[0])-xd[0]);
out[7] = (real_t)(0.0000000000000000e+00);
out[8] = ((((real_t)(0.0000000000000000e+00)-((real_t)(3.8360220155627253e+01)*a[5]))*xd[1])-((real_t)(0.0000000000000000e+00)-(((real_t)(2.2981725564623270e+02)*xd[2])*a[7])));
out[9] = ((real_t)(3.8360220155627253e+01)/xd[0]);
out[10] = ((real_t)(0.0000000000000000e+00)-((real_t)(2.2981725564623270e+02)*a[6]));
out[11] = (real_t)(3.7957866767887642e-04);
}
...
{
tmp_index1 = (run1 * 3) + (j);
acadoWorkspace.rk_A[tmp_index1 * 3] = + acado_Ah_mat[run1]*acadoWorkspace.rk_diffsTemp2[(run1 * 12) + (j * 4)];
acadoWorkspace.rk_A[tmp_index1 * 3 + 1] = + acado_Ah_mat[run1]*acadoWorkspace.rk_diffsTemp2[(run1 * 12) + (j * 4 + 1)];
acadoWorkspace.rk_A[tmp_index1 * 3 + 2] = + acado_Ah_mat[run1]*acadoWorkspace.rk_diffsTemp2[(run1 * 12) + (j * 4 + 2)];
...
acadoWorkspace.rk_diffsNew2[(i * 4) + (run1)] += + acadoWorkspace.rk_diffK[i]*(real_t)3.3333333333333335e-03;
}
}
for (run1 = 0; run1 < 1; ++run1)
{
...
for (i = 0; i < 3; ++i)
{
acadoWorkspace.rk_diffsNew2[(i * 4) + (run1 + 3)] = + acadoWorkspace.rk_diffK[i]*(real_t)3.3333333333333335e-03;
}
}
