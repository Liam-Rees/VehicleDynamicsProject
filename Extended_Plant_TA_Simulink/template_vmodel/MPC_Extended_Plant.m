...
switch controller_choice
    ...
    case 2
        ...
        f_ctrl = [
                dot(vy)    == -(par.Caf+par.Car)/(par.mass*vx)*vy+((par.l_r*par.Car-par.l_f*par.Caf)/(par.mass*vx)-vx)*r;...
                dot(r)     == (par.l_r*par.Car-par.l_f*par.Caf)/(par.Izz*vx)*vy-(par.l_r^2*par.Car+par.l_f^2*par.Caf)/(par.Izz*vx)*r+Mz/par.Izz];
